...
FORBIDDEN='(\b(claude|anthropic|openai|chatgpt|sonnet|haiku|gemini|copilot|mistral|grok)\b|\bclaude[- ]opus\b|gpt-?[0-9]+|\bllama[- ]?[0-9]|\bby (claude|ai|gpt|an ai)\b|(ai|machine)-generated|generated by (an? )?(ai|llm|model)|feito por|criado por|autor:\s|made by|written by|credit to)'
