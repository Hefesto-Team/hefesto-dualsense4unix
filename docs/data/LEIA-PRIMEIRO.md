...
inteiro (<!--@caracteres-do-mapa-->1.447.035<!--/--> caracteres em células,
~<!--@tokens-do-mapa-->362<!--/--> mil tokens) ou não ler nada. O
...
|---|---:|---|---|
| `docs/data/mapa-controles.csv` | <!--@bytes:docs/data/mapa-controles.csv-->1.507.423<!--/--> | **A FONTE.** <!--@linhas-do-mapa-->314<!--/--> linhas x <!--@colunas-do-mapa-->50<!--/--> colunas. Uma linha = uma feature em um controle. É portão, não documentação. | Sempre, mas **filtrado** — nunca com `Read` inteiro. Veja a seção 5. |
