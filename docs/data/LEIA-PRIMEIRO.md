...
inteiro (<!--@caracteres-do-mapa-->1.410.695<!--/--> caracteres em células,
~<!--@tokens-do-mapa-->353<!--/--> mil tokens) ou não ler nada. O
...
|---|---:|---|---|
| `docs/data/mapa-controles.csv` | <!--@bytes:docs/data/mapa-controles.csv-->1.470.191<!--/--> | **A FONTE.** <!--@linhas-do-mapa-->311<!--/--> linhas x <!--@colunas-do-mapa-->50<!--/--> colunas. Uma linha = uma feature em um controle. É portão, não documentação. | Sempre, mas **filtrado** — nunca com `Read` inteiro. Veja a seção 5. |
| `docs/data/ensaios.csv` | <!--@bytes:docs/data/ensaios.csv-->195.521<!--/--> | **O LASTRO.** <!--@linhas-do-caderno-->230<!--/--> ensaios x <!--@colunas-do-caderno-->14<!--/--> colunas. Cada linha é uma medição com hardware na mesa. Casa com o mapa por `linha_id == id`. **`degrau` e `ponte` existem no cabeçalho desde 20/08/2026 e quase ninguém as respondeu:** `ponte` está vazia em <!--@caderno-sem-ponte-->230<!--/--> ensaios e `degrau` em <!--@caderno-sem-degrau-->206<!--/-->. Não procure dado que ninguém escreveu ainda. | Quando a célula do mapa diz `medido` e você quer ver a medição. |
| `html/specs.html` | <!--@bytes:html/specs.html-->2.262.738<!--/--> | **DERIVADO** do CSV + do caderno, por `scripts/gerar-mapa.py`. Filtra no navegador. Mudou da raiz para `html/` em 25/08/2026. | **IA: não abra.** Ele embute o CSV inteiro como JSON: custa ~2x a fonte pela mesma informação. É excelente para olho humano com navegador, e péssimo para leitura por texto. |
| `docs/protocol/dualsense-referencia-canonica.md` | <!--@bytes:docs/protocol/dualsense-referencia-canonica.md-->112.594<!--/--> | **O PROTOCOLO.** O que o DualSense entende, byte a byte. | Quando a pergunta é "que report/offset/valor eu mando". Use a régua de conversão da seção 6. |
...
`id` é sempre exatamente `chave@controle` (confere em 308 de <!--@linhas-do-mapa-->311<!--/--> linhas), então
...
- `ponte_alcanca` / `ponte_de_onde_sei` — **o eixo de ponte** (20/08/2026), e
  ...
  <!--@linhas-do-mapa-->311<!--/--> linhas hoje, todas com `gamepad/dualsense` + `inferido-do-codigo`. Quem
...
cruzamento das 616 células (<!--@linhas-do-mapa-->311<!--/--> linhas x 2 lados), medido em 02/09/2026:
...
**O mapa da ignorância, de graça:** o caderno cobre **30 das <!--@linhas-do-mapa-->311<!--/--> linhas
...
o trecho abaixo em 22/08/2026)**:** só **37 das <!--@linhas-do-mapa-->311<!--/--> linhas** têm
...
- `provado_por` (mapa, <!--@mapa-com-provado-por-->82<!--/--> linhas:
  ...
  <!--@caderno-com-observado-por-->230<!--/--> linhas: `olho-dela`
  <!--@caderno-observado-olho-dela-->135<!--/-->, `bancada`
  <!--@caderno-observado-bancada-->65<!--/-->, `aparelho`
  <!--@caderno-observado-aparelho-->23<!--/-->) fazem a mesma pergunta com
