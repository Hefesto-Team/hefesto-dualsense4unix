...
inteiro (<!--@caracteres-do-mapa-->1.422.303<!--/--> caracteres em células,
...
|---|---:|---|---|
| `docs/data/mapa-controles.csv` | <!--@bytes:docs/data/mapa-controles.csv-->1.482.247<!--/--> | **A FONTE.** <!--@linhas-do-mapa-->313<!--/--> linhas x <!--@colunas-do-mapa-->50<!--/--> colunas. Uma linha = uma feature em um controle. É portão, não documentação. | Sempre, mas **filtrado** — nunca com `Read` inteiro. Veja a seção 5. |
