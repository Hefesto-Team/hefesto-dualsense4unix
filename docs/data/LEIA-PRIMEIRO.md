...
inteiro (<!--@caracteres-do-mapa-->1.416.613<!--/--> caracteres em células,
~<!--@tokens-do-mapa-->354<!--/--> mil tokens) ou não ler nada. O
...
|---|---:|---|---|
| `docs/data/mapa-controles.csv` | <!--@bytes:docs/data/mapa-controles.csv-->1.476.319<!--/--> | **A FONTE.** <!--@linhas-do-mapa-->312<!--/--> linhas x <!--@colunas-do-mapa-->50<!--/--> colunas. Uma linha = uma feature em um controle. É portão, não documentação. | Sempre, mas **filtrado** — nunca com `Read` inteiro. Veja a seção 5. |
| `docs/data/ensaios.csv` | <!--@bytes:docs/data/ensaios.csv-->200.665<!--/--> | **O LASTRO.** <!--@linhas-do-caderno-->233<!--/--> ensaios x <!--@colunas-do-caderno-->14<!--/--> colunas. Cada linha é uma medição com hardware na mesa. Casa com o mapa por `linha_id == id`. **`degrau` e `ponte` existem no cabeçalho desde 20/08/2026 e quase ninguém as respondeu:** `ponte` está vazia em <!--@caderno-sem-ponte-->233<!--/--> ensaios e `degrau` em <!--@caderno-sem-degrau-->206<!--/-->. Não procure dado que ninguém escreveu ainda. | Quando a célula do mapa diz `medido` e você quer ver a medição. |
| `html/specs.html` | <!--@bytes:html/specs.html-->2.277.218<!--/--> | **DERIVADO** do CSV + do caderno, por `scripts/gerar-mapa.py`. Filtra no navegador. Mudou da raiz para `html/` em 25/08/2026. | **IA: não abra.** Ele embute o CSV inteiro como JSON: custa ~2x a fonte pela mesma informação. É excelente para olho humano com navegador, e péssimo para leitura por texto. |
...
| `scripts/check_paridade_transporte.py` | <!--@bytes:scripts/check_paridade_transporte.py-->145.510<!--/--> | **O PORTÃO** do mapa, e a melhor explicação de método da casa — a docstring nomeia cada regra e o defeito real que a fez nascer. | Antes de escrever no CSV. Leia a docstring inteira — ela vai da linha 2 à <!--@ultima-linha-da-docstring-do-portao-->343<!--/-->. |
...
- `provado_por` (mapa, <!--@mapa-com-provado-por-->83<!--/--> linhas:
  ...
  <!--@caderno-com-observado-por-->233<!--/--> linhas: `olho-dela`
  <!--@caderno-observado-olho-dela-->135<!--/-->, `bancada`
  <!--@caderno-observado-bancada-->65<!--/-->, `aparelho`
