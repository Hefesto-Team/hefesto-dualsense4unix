...
> | pré-amp, `common[37]` | `core/backend_pydualsense.py:1847-1854`, com o `VALID_FLAG1_AUDIO_CONTROL2_ENABLE` em `:1850-1852`; o valor padrão `0x2` é o `SP_PREAMP_GAIN_PADRAO` em `core/ds_output_report.py:197` | **ALTA** — lido no código |
...
> | entrega ao vpad na borda | `core/physical_report_reader.py:1103-1138` (`_observe_jack`) | **ALTA** |
