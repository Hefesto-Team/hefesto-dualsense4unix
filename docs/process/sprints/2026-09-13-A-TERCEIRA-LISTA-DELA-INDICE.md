...
| [MODO-DE-CONEXAO-01](2026-09-13-MODO-DE-CONEXAO-01-o-degrau-xbox-que-diz-aplicado-e-nao-vale-e-o-texto-que-e-da-mascara.md) | pedido dela de 13/09, à tarde: o modo da aba Jogar diz «aplicado» e não vale, e o texto do Xbox é o da máscara; e a regra dela, minutos depois: o modo é a base (o chip e o PS + R3), a máscara vem por cima, os dois valem com o jogo aberto e o PS + R3 grava no perfil | costurada (a segunda validação, depois da queda da internet) |
| [RESTOS-DA-ONDA-TRES-01](2026-09-13-RESTOS-DA-ONDA-TRES-01-a-guarda-que-a-paridade-nao-viu-a-docstring-da-gui-a-dona-do-sensor-e-a-ressalva-da-biblioteca.md) | a guarda do alto-falante que a paridade não viu, a docstring que ainda diz «a GUI», a dona da linha do sensor e a ressalva da biblioteca nas células do giroscópio e do acelerômetro | 4 · costurada |
| [A-MARCA-DA-DEGRADACAO-01](2026-09-13-A-MARCA-DA-DEGRADACAO-01-o-asterisco-que-nunca-acende-e-o-gerador-que-escreve-antes-de-conferir.md) | o asterisco da emulação degradada que nunca acende e seria dica de aviso; o gerador que escreve antes de conferir | 5, junto com a SOM-TRAVA-NA-QUEDA-01 |
| [SOM-TRAVA-NA-QUEDA-01](2026-09-13-SOM-TRAVA-NA-QUEDA-01-o-gravador-que-nao-morre-e-o-servidor-de-som-que-espera-por-ele.md) | pedido dela de 13/09, 17h: o som da máquina e a Steam travam quando um controle BT cai com o alto-falante do Hefesto de pé; o `pw-record` da ponte não morre | 5, rota escrita: implementa → valida |
