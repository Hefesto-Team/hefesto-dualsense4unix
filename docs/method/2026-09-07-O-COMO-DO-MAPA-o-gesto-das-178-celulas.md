...
9. Abra um programa que ouça microfone — um gravador ou uma chamada de voz — e escolha como entrada a do P1: «Microfone do Controle 1 (DualSense Wireless Controller)», ou, se ela não estiver na lista, a placa DualSense do próprio controle, a que não começa com «Microfone do Controle».
...
11. Feche o programa.
12. Clique na linha do P2 e refaça nele a mesma rodada, da pílula ATIVO até fechar o programa, com «Microfone do Controle 2 (DualSense Wireless Controller)».
...
11. Abra um programa que ouça microfone e escolha como entrada «Microfone do Controle 3 (DualSense Wireless Controller)».
...
13. Troque a entrada do programa para «Microfone do Controle 4 (DualSense Wireless Controller)» e confira o mesmo no P4.
14. Feche o programa.
...
**Onde olhar.** Na aba Conexões, em duas seções. A seção «Rádio e Adaptadores» abre clicando no título dela: cada adaptador de rádio é um cartão, o cartão diz em que entrada ele está encaixado (por exemplo «Entrada 1-4»; numa máquina com mais de um controlador USB, o número antes do traço diz o controlador — atrás de um hub a entrada sai com pontos, como «Entrada 4.1.4», sem esse número), e os controles que falam por ele aparecem dentro do cartão — se a lista estiver fechada, a setinha ao lado do nome a abre. No pé dessa seção fica o botão «Examinar Entradas», que refaz o exame e repinta o «Check-up», a primeira seção da aba. No «Check-up», uma das linhas fala de aparelho encaixado colado a um adaptador Bluetooth: com tudo certo ela diz que nenhum está colado; senão, ela conta os pares em portas coladas. Os cabos não têm cartão em «Rádio e Adaptadores» — o número antes do traço é só o do adaptador —, e essa linha do «Check-up» mede entradas COLADAS, que é parecido e não é a mesma coisa. Quem responde de verdade este teste são os aparelhos: a barra de luz do P1 e do P2 (as duas tiras acesas dos lados do touchpad) e o tremor deles na sua mão.
...
**A armadilha.** Três coisas fazem você julgar errado aqui. A primeira é a palavra do mapa: nesta linha está escrito que o dano NÃO foi acionado, e isso não quer dizer que a topologia não exista — ela existe e foi medida, o adaptador de rádio e os dois cabos penduram no mesmo controlador da máquina. É justamente esse arranjo o suspeito do defeito antigo em que um controle do cabo matava a saída do controle do rádio. A segunda é o «Check-up»: a linha do aparelho colado olha entradas COLADAS uma na outra, e verde ali não diz que as coisas não dividem o mesmo controlador — quem diz é o «Mapear Entradas», no pé de «Rádio e Adaptadores», que traz o caminho de cada aparelho: o número antes do primeiro traço é o controlador, e cabo e adaptador com o mesmo número dividem o mesmo. A terceira é o tamanho da carga: a única medição que existe carregou o controlador com CAPTURA DE MICROFONE, não com o vaivém de comandos de um jogo a plena carga; verde sob carga leve não é verde sempre. E a prova desta linha parou no fio: ninguém mediu com o adaptador mudado de lugar, e ninguém mediu com os comandos a plena carga. Duas coisas miúdas: enquanto um cabo está fora da entrada, o lugar daquele controle fica guardado por trinta segundos e ninguém troca de número — se a troca de entrada passar disso, a fila se fecha de propósito e os que vêm depois dele descem um número até ele voltar, e cada um recupera o seu quando ele volta; e um quadradinho de cor com X é a cor de outro controle, que não aceita o clique. Por último: se o cartão disser que o adaptador é de dentro da máquina, ele não sai do lugar, e este teste roda só mexendo nos cabos.
...
**Onde olhar.** Na aba Conexões, seção «Rádio e Adaptadores», que abre clicando no título: cada adaptador é um cartão que diz em que entrada ele está encaixado (por exemplo «Entrada 3-4»; numa máquina com mais de um controlador USB, o número antes do traço diz o controlador — atrás de um hub a entrada sai com pontos, como «Entrada 4.1.4», sem esse número), e os controles que falam por ele aparecem DENTRO do cartão — é assim que você sabe por qual adaptador o P3 e o P4 estão falando. Se a lista de um cartão estiver fechada, a setinha ao lado do nome a abre. No pé da seção fica o botão «Examinar Entradas», que refaz o exame e repinta o «Check-up», no alto da aba, onde uma linha fala de aparelho encaixado colado a um adaptador Bluetooth. Quem responde este teste são os aparelhos: as barras de luz do P3 e do P4 e o tremor deles na sua mão.

**Os passos.**

* Abra a aba Conexões.
1. Clique no título «Rádio e Adaptadores» para abrir a seção.
2. Anote num papel, cartão por cartão, a entrada de cada adaptador e quais controles aparecem dentro dele — se a entrada vier com pontos, anote também, do «Mapear Entradas», o número antes do primeiro traço do Bluetooth cujo caminho termina nela.
...
13. Na aba Conexões, confira que o cartão desse adaptador passou a dizer a entrada nova e que o P3 e o P4 voltaram para dentro dele — se o número antes do traço mudou (numa entrada com pontos, o do «Mapear Entradas», como no passo 2), o adaptador mudou de controlador USB, e isso vai para o papel.
...
2. Confira na fita do topo que sobraram dois chips, os dois dizendo BT, e espere os dois passarem a dizer P1 e P2 antes de seguir — nos primeiros trinta segundos com os do cabo fora eles continuam P3 e P4, e é passado esse prazo que a fila se fecha. Chame de A o controle que era o P3 e de B o que era o P4, e siga-os pela cor do plástico.
...
4. Espere os dois chips passarem a dizer P1 e P2, e mais meio minuto, antes de seguir — nos primeiros trinta segundos com os do cabo fora eles continuam P3 e P4; passado o prazo a fila se fecha, as colunas andam para o lugar do número novo na hora, e as lampadinhas e a cor da barra acompanham em até meio minuto. Chame de A o que era o P3 e de B o que era o P4, e siga-os pela cor do plástico.
...
4. Espere os chips dos dois do rádio passarem a dizer P2 e P3, e mais meio minuto, antes de seguir — nos primeiros trinta segundos com o P2 fora ninguém troca de número; passado o prazo a fila se fecha, os dois do rádio descem um número e as colunas deles andam junto na hora, e as lampadinhas e a cor da barra acompanham em até meio minuto. Chame de A o que era o P3 e de B o que era o P4, e siga-os pela cor do plástico.
...
**A armadilha.** A leitura em si já foi medida no aparelho, em 06/09, com estes quatro controles ligados — o que não foi medido é a escada de degraus, que é outro teste. Quatro números iguais e parados não são aprovação nem defeito: podem ser quatro controles no mesmo estado, e quem decide a escada é o teste dos degraus, com as duas leituras separadas por quarenta minutos. Os gamepads virtuais que o Hefesto cria têm registro de bateria próprio no sistema, que diz «carregando» para sempre; desde 06/09 o Hefesto deixou de lê-los, e o número destas três telas vem do próprio controle. Segunda armadilha: o lugar do P1 fica guardado por trinta segundos, como o de qualquer um dos quatro, e dentro desse prazo ninguém troca de número — os dois segundos do passo 9 cabem com folga; se passar disso, a fila se fecha de propósito e os outros três descem um número até ele voltar, e é por isso que o passo 13 manda seguir pela cor do plástico. O P1 é o primeiro controle, e o posto dele fica guardado só por trinta segundos: devolva o cabo dentro desse tempo. Se o P1 já foi pareado por rádio nesta máquina, sem o cabo ele pode voltar pelo rádio — a linha dele passa a dizer BT, e aí você mediu outra coisa. E leia a bateria nas linhas fechadas: no cartão aberto o número do controle some do começo da linha, e é fácil anotar o número do controle errado.
...
* **P3** — No rádio, e não se toca nele. Testemunha do outro transporte: chip na fita o tempo todo; o número dele fica nos primeiros trinta segundos da ausência do P1, desce um passado o prazo, e tem de voltar quando o P1 volta.
...
**A armadilha.** NÃO CLIQUE em «Parar o serviço». Ele derruba o Hefesto inteiro e os quatro controles viram gamepads comuns do Linux; se clicar sem querer, ele pergunta antes — responda que não. Segurar o PS por mais de um segundo não dispara nada no Hefesto: o que abre a Steam é o toque CURTO no PS de um controle ligado, que é um atalho do produto. Por isso o passo 11 só toca o PS se o P1 estiver apagado; se a Steam abrir, feche-a por inteiro e refaça. O lugar do P1 fica guardado por trinta segundos, como o de qualquer um dos quatro, contados de quando o chip dele some da fita; passado o prazo, a fila se fecha de propósito — na tela na hora, nas lâmpadas junto com a cor da barra e, com um jogo aberto, no jogo também. E não escreva «reprovou» porque não achou o botão: aqui a ausência é a resposta certa. Onde a prova parou: ninguém nesta casa localizou o comando de desligar por software, e ninguém mediu se ele existe — a faixa de perguntas que o aparelho responde foi varrida em 15/08 e nada de energia voltou, mas ESCREVER no aparelho para desligá-lo nunca foi tentado. O PS5 desliga este mesmo controle por software, então o caminho existe no aparelho; o que falta é o nosso conhecimento dele.
...
* **P1** — No cabo, e sai do teste: o cabo dele é puxado para que um controle do rádio assuma o Navega o PC. Nos primeiros trinta segundos com os dois do cabo fora, ninguém troca de número; passado o prazo, a fila se fecha e os que ficam contam de 1 em diante na tela — o P3 aparece como P1 e o P4 como P2 —, e é por isso que o controle se reconhece pela cor. No fim, encaixe o cabo de volta e confirme que ele voltou como P1, com USB.
...
17. Na aba Controles, acenda a «Mira Virtual» do controle que navega o PC e a do P3; na aba Navegação, confira que o cartão do P3 passou a dizer BT • Move o cursor, e volte à página longa.
...
* **P3** — No rádio, e é testemunha. Empurre os dois analógicos dele e confira que o cursor não anda — não é defeito, é o produto: o cursor do PC é um só e sai de um controle só. Com a «Mira Virtual» dele acesa é diferente: o giro dele move o cursor, porque a Mira vale nos quatro, e o cartão dele diz BT • Move o cursor.
...
15. Na aba Controles, acenda a «Mira Virtual» do controle que navega o PC e a do outro controle do rádio; na aba Navegação, confira que o cartão do outro controle do rádio passou a dizer BT • Move o cursor, e volte à página longa.
...
**Onde olhar.** Na aba Controles, no meio do cartão de cada controle. Ficam ali Analógico esquerdo, com a marca L3 dentro do círculo, e Analógico direito, com a marca R3. Cada um tem um círculo com um pontinho dentro e dois números embaixo: X: e Y:. O pontinho anda dentro do círculo acompanhando o polegar, e cada número vai de 0 a 255. O círculo mostra só o polegar, lido do aparelho: a «Mira Virtual», no alto do cartão, soma o giro ao analógico direito que o JOGO vê, e não a este desenho. E no alto de qualquer aba, à direita, a contagem dos ligados: 2 USB · 2 BT.
...
**Onde olhar.** Na aba Gatilhos, no quadro Gatilhos. Cada controle é uma coluna, com o chip no alto — o número, a cor do plástico e USB ou BT; o da coluna do P3 e o da do P4 têm de dizer BT. A coluna da esquerda nomeia as linhas: Controle e depois duas seções tituladas por um desenho, o L2 em cima e o R2 embaixo, cada uma com Modo e Efeito pronto. As colunas seguem o número de cada controle: com um controle fora, a coluna dele passa a dizer «Desconectado» ao lado do número, e as outras ficam onde estão até a fila se fechar, trinta segundos depois. A prova, porém, é a sua mão: o controle não devolve em que efeito está, e o campo Modo mostra o que foi pedido. A tela só pisca em verde por cerca de um segundo e meio quando o comando sai.
...
**Onde olhar.** Na aba Gatilhos, quadro Gatilhos. O chip no alto da coluna do P3 e o da do P4 têm de dizer BT. A seção de BAIXO da coluna da esquerda é a do R2, titulada pelo desenho R2, com Modo e Efeito pronto; a de cima é a do L2 e não se toca. As colunas seguem o número de cada controle: com um controle fora, a coluna dele passa a dizer «Desconectado» ao lado do número, e as outras ficam onde estão até a fila se fechar, trinta segundos depois. A prova é a sua mão: o controle não devolve em que efeito está, e o campo Modo mostra só o pedido; a tela pisca em verde por cerca de um segundo e meio quando o comando sai.
...
6. Confira que, enquanto ele está fora, ninguém troca de número: a linha dele passa a dizer «Player 1 • Desconectado» e as outras três ficam como estavam.
...
* **P3** — No rádio, testemunha. Enquanto um dos do cabo está fora, a linha dele continua com o mesmo número — o lugar de quem saiu fica guardado —, e ela não pode sumir nem trocar de cor em instante nenhum.
...
**A armadilha.** O verde deste teste é fácil de conseguir por engano, e vale saber por quê: o Hefesto guarda a cor do plástico de cada APARELHO pelo endereço, que é o mesmo no cabo e no rádio. Se o crachá funcionar, o nome da cor reaparece no rádio SEM nova pergunta — e é isso que este teste quer ver. Mas o contrário também vale: este teste NÃO prova que a leitura da cor pelo rádio funciona; quem prova isso é o teste próprio dela. Segunda: o lugar de quem sai fica guardado por trinta segundos, e dentro desse prazo ninguém troca de número; se a travessia passar disso, a fila se fecha de propósito e os de trás descem um número até ele voltar — isso não é crachá quebrado. O número de quem volta é o de antes a qualquer tempo, enquanto o serviço estiver de pé; o que reprova é o P1 VOLTAR com outro número. Terceira: quando a fila se fecha, as lampadinhas embaixo do touchpad mudam junto com a cor da barra, e podem levar até meio minuto a mais que a tela; olhe a tela, não o aparelho. Quarta: se o P1 era o que diz Navega o PC na aba Navegação e ficar mais de meio minuto fora, o posto fica com outro controle — confira no fim e anote, porque os testes de navegação dependem disso. Quinta: até hoje isto foi medido em quatro aparelhos, e é amostra — o que sustenta a generalização é o mecanismo, não a contagem.
...
5. Confira que, enquanto ele está fora, a linha dele passou a dizer «Player 3 • Desconectado» e a do P4 continua dizendo Player 4.
...
* **P4** — No rádio, o segundo a atravessar. Enquanto o P3 está apagado, ele continua Player 4 — o lugar do P3 fica guardado por trinta segundos —; se a travessia passar disso, ele desce a Player 3 até o P3 voltar. Ele é o último da fila — se o P3 volta certo e ele não, o achado é do quarto lugar, não do transporte.

**A armadilha.** A armadilha própria deste lado é o sono do controle: um controle que dormiu não reaparece sozinho quando você pluga o cabo — já foi medido nesta casa. Se ele não acender ao ser plugado, dê um toque no PS; sem isso você anotaria "sumiu no cabo" sobre um aparelho que está apenas dormindo. Segunda: o nome da cor pode APARECER só depois de ele ir para o cabo e nunca antes. Isso não é o crachá falhando — é a leitura da cor pelo rádio, que só está provada em duas unidades e tem teste próprio. O que reprova AQUI é a cor MUDAR entre os dois transportes, ou o número de quem voltou ser outro. Terceira: o lugar de quem sai fica guardado por trinta segundos, e dentro desse prazo ninguém troca de número; se a travessia passar disso, a fila se fecha de propósito e os de trás descem um número até ele voltar. O número de quem volta é o de antes a qualquer tempo, enquanto o serviço estiver de pé. Quando a fila se fecha, as lampadinhas do aparelho mudam junto com a cor da barra, e podem levar até meio minuto a mais que a tela. Quarta: não segure o PS por tempo demais ao religar — se a Steam vier para a frente, feche-a e refaça.
...
8. Confira que as linhas do P1, do P2 e do P4 não mudaram de número — o lugar do P3 fica guardado para ele.
9. Aperte uma vez o botão PS do P3 e espere o chip dele voltar à fita do topo.
10. Leia de novo a contagem e as quatro linhas: o P3 voltou como Player 3, e o P4 está como Player 4.
...
* **P4** — No rádio, e é ele que fecha o teste: o segundo do mesmo transporte, feito depois. Enquanto o P3 está fora ele continua Player 4 — o lugar do P3 fica guardado por trinta segundos —; se o PS do P3 demorar mais que isso, ele desce a Player 3 até o P3 voltar. Se o P3 volta certo e o P4 não, o achado é do quarto lugar na fila, não do rádio.

**A armadilha.** O falso verde é olhar só a tela: se a borda do botão piscar em laranja e o controle não apagar, nada foi derrubado e nada foi reconectado — o teste não provou coisa nenhuma, refaça. Olhe o controle: se ele não apagou, não caiu. Segunda: o lugar do P3 fica guardado por trinta segundos, e dentro desse prazo ninguém troca de número; se o PS demorar mais que isso, a fila se fecha de propósito e o P4 desce para Player 3 até o P3 voltar — isso é a regra do produto, e não o defeito. O número do P3 volta a qualquer tempo enquanto o serviço estiver de pé — o que reprova é ele voltar com outro número ou aparecer uma linha a mais. Quando a fila se fecha, as lampadinhas do aparelho mudam junto com a cor da barra e podem levar até meio minuto a mais que a tela, e é por isso que o passo espera antes de contar. Terceira: Cancelar não religa nada — se você clicar nele, o controle fica fora do rádio até você apertar o PS por conta própria. Quarta: este gesto refaz a conexão de um controle que JÁ está pareado neste computador. Parear um aparelho novo é na seção Rádio e Adaptadores, e não é este teste; se aquele controle nunca foi pareado aqui, o PS não o traz de volta e o teste não roda.
...
* **P3** — No rádio, testemunha. Enquanto os do cabo estão fora, a linha dele fica no lugar nos primeiros trinta segundos e, passado o prazo, sobe na lista até eles voltarem; ela não pode sumir nem trocar de cor, e a contagem do quadro tem de continuar dizendo dois no rádio o tempo todo.
...
5. Confira que a contagem no alto da janela passou a mostrar só os dois do USB, e espere mais meio minuto antes de religar qualquer um — passado esse prazo, a fila se fecha e o lugar do P3 e o do P4 deixam de estar guardados.
6. Dê um toque no PS do controle que ANTES era o P4 — agora ele entra primeiro — e veja o chip dele aparecer na fita.
7. Leia a linha dele e anote: com o prazo vencido e sozinho no BT, ele aparece como Player 3.
...
**A armadilha.** A ordem de partida importa, e é por isso que a primeira coisa a fazer é copiar as quatro linhas — se você não tiver certeza de quem entrou primeiro, o papel do começo é quem responde. Passado o prazo do lugar guardado, o número na tela é contado só entre os presentes, pela ordem em que cada controle chegou pela primeira vez desde que o serviço subiu: enquanto o antigo P3 está fora, o antigo P4 aparece como Player 3, e isso não é defeito; com os dois de volta, cada um tem de recuperar o seu. É por isso que o passo 5 espera meio minuto: religado antes do prazo, o antigo P4 voltaria direto ao lugar dele, que estava guardado, e o teste não passaria pela terceira posição. Não reinicie o serviço no meio do teste — o reinício apaga essa ordem, e aí os números passam a seguir a ordem de entrada. As lampadinhas do aparelho mudam junto com a cor da barra e podem levar até meio minuto a mais que a tela; olhe a tela. Segunda: se um dos dois voltar sem nome de cor, a linha simplesmente não traz o nome, e isso é achado da leitura da cor pelo rádio, que tem teste próprio; aqui o que reprova é a cor TROCAR DE DONO. Terceira: espere a contagem cair antes de religar — religar com o Hefesto ainda contando quatro mede outra coisa. Quarta: não plugue cabo em nenhum dos dois durante o teste — pelo cabo a identidade tem outro caminho, e uma passagem pelo fio no meio embaralharia o resultado.
...
4. Confira que o amarelo ganhou a borda na coluna do P1 e um X nas colunas do P2, do P3 e do P4.
...
23. Clique em «Desligar», na linha «Opções» da coluna do P1, e confira que a barra dele apaga e que o número da linha «Brilho» vai a 0%.
24. Na aba Perfis, ative outro perfil e depois o anotado, como no passo 20.
25. Volte à aba Iluminação e confira que a barra do P1 continua apagada, a linha «Brilho» dele continua em 0%, e a borda continua no amarelo.
26. Clique no quadradinho amarelo da coluna do P1 e confira que a barra volta acesa, amarela.
27. Devolva os quatro números de brilho aos valores anotados.
28. Clique no quadradinho da cor do número de cada um para devolver a cor: o primeiro no P1, o segundo no P2.

**Passa quando.** Nos dois controles do cabo a barra escurece junto com o número, some POR COMPLETO no 0 e volta cheia no 100, sem mudar de cor. Mexer no brilho de um nunca mexe no de outro. A marca da cor não sai do lugar em parada nenhuma, nem no 0: a borda fica na cor do próprio controle, e o X dela fica nas colunas dos outros três. As três voltas de «Salvar Perfil», «Aplicar» e troca de perfil deixam as quatro barras exatamente como estavam — nenhuma fica mais fraca a cada volta. E o P1 «Desligado» atravessa a troca de perfil apagado, com o trilho em 0% e a cor dele guardada, e um clique na cor o acende de novo.
...
6. Confira que o amarelo ganhou a borda na coluna do P3 e um X nas colunas do P1, do P2 e do P4.
...
24. Clique em «Desligar», na linha «Opções» da coluna do P3, e confira que a barra dele apaga e que o número da linha «Brilho» vai a 0%.
25. Na aba Perfis, ative outro perfil e depois o anotado, como no passo 21.
26. Volte à aba Iluminação e confira que a barra do P3 continua apagada, a linha «Brilho» dele continua em 0%, e a borda continua no amarelo.
27. Clique no quadradinho amarelo da coluna do P3 e confira que a barra volta acesa, amarela.
28. Devolva os quatro números de brilho aos valores anotados.
29. Clique no quadradinho da cor do número de cada um para devolver a cor: o terceiro no P3, o quarto no P4.

**Passa quando.** Nos dois controles do rádio a barra escurece junto com o número, some POR COMPLETO no 0 e volta cheia no 100. Mexer no brilho de um nunca mexe no de outro nem nos dois do cabo. A marca da cor não sai do lugar em parada nenhuma, nem no 0: a borda fica na cor do próprio controle, e o X dela fica nas colunas dos outros três. As três voltas de «Salvar Perfil», «Aplicar» e troca de perfil deixam as quatro barras exatamente como estavam — nenhuma fica mais fraca a cada volta. E o P3 «Desligado» atravessa a troca de perfil apagado, com o trilho em 0% e a cor dele guardada, e um clique na cor o acende de novo.
...
7. Confira que o «Giroscópio» e a «Mira Virtual» da mesma linha e os três interruptores do P2, do P3 e do P4 não mudaram.
...
**Passa quando.** O clique no «Acelerômetro» do P1 troca a cor da bolinha DELE e de mais nada, e a borda pisca verde; o mesmo no P2. O «Giroscópio» e a «Mira Virtual» da mesma linha e as linhas dos outros não se mexem. No fim, os doze voltam ao que eram.
...
* **P2** — No cabo, e é o segundo. Antes de clicar, olhe onde estão as doze bolinhas: o defeito que este teste caça é um clique numa linha mexer noutra.
...
6. Confira que a bolinha dele trocou de cor, e anote a cor em que a borda piscou.
7. Confira que o «Giroscópio» e a «Mira Virtual» da mesma linha e os três interruptores do P1, do P2 e do P4 não mudaram.
...
* **P1** — No cabo, testemunha. Não clique em nada na linha dele.
* **P2** — No cabo, segunda testemunha. Se o P1 ficou parado e o P2 mudou junto com o P3, o clique acertou o controle errado — e não o transporte.
* **P3** — No rádio, e é o primeiro em que você clica. O «Acelerômetro» da mesma linha não pode mudar junto. É também o controle em que a Mira acende no fim.
* **P4** — No rádio, e é o segundo. Sem anotar as doze bolinhas antes, este teste não mede nada. Com a Mira acesa no P3, a dica do «Giroscópio» dele não pode mudar.

**A armadilha.** Quatro. (1) Se um jogo não reagir ao movimento pelo rádio, a primeira suspeita é a biblioteca que o jogo carrega, não o Hefesto: o giro chega inteiro ao controle virtual nos dois transportes, e este teste mede o interruptor, não o jogo. (2) PELO RÁDIO, MOVIMENTO E VOZ DIVIDEM A MESMA FILA: com o microfone daquele controle no ar, parte dos pacotes leva voz, e o movimento chega mais ralo — é desenho; o número de cada um está em «Rádio e Adaptadores», na aba Conexões. (3) Visto como «Xbox 360», o jogo não tem giroscópio. (4) Borda laranja com a bolinha trocando é meia obediência (Modo Nativo); com a bolinha parada, o Hefesto sem saber o estado do sensor. No Modo Nativo a «Mira Virtual» fica cinza e não grava, e a dica do «Giroscópio» continua a de sempre — é o produto certo. O mapa registra o giro MONTADO na janela que vai ao controle virtual.
...
12. Espere trinta segundos, contados de quando o chip do P3 sai da fita, e olhe o quadro «O controle é visto como:»: o cartão «Player 3» passa a mostrar o plástico do P4, com o chip «DualSense» aceso — a escolha acompanha o aparelho, não o lugar.
...
**Passa quando.** A escolha feita no cartão do P3 muda o desenho dos botões do jogador do P3 no jogo, e de mais ninguém. Passados trinta segundos com o P3 desligado, o cartão que passa a ocupar o lugar dele mostra a escolha do P4, e não a do P3. E depois de o P3 cair e voltar pelo rádio, o cartão dele volta com o mesmo número e com a mesma escolha de antes — a escolha é do aparelho, não da sessão nem do lugar.
...
* **P4** — BT, e é o vizinho que prova a outra metade: passados trinta segundos com o P3 fora, ele aparece no lugar «Player 3» com a escolha DELE, «DualSense». Se ele aparecer ali com «Xbox 360», a escolha ficou presa ao lugar em vez de ao aparelho, e esse é o achado.

**A armadilha.** Quatro. (1) O lugar de quem sai fica guardado por trinta segundos, contados de quando o chip dele some da fita: até lá ninguém troca de número. Passado o prazo, a fila se fecha de propósito: os que vêm depois dele descem um número — o P4 passa a aparecer como P3 —, na tela na hora, nas lâmpadas junto com a cor da barra e, com um jogo aberto, no jogo também, onde cada um renasce no boneco do número novo e some por cerca de um segundo. Quando o que saiu volta, cada um volta ao seu. Isso é o produto, não defeito; por isso os passos seguem o P3 pelo plástico. (2) Não há prazo para a volta: o número e a escolha voltam com o aparelho enquanto o serviço estiver de pé, demore o que demorar. (3) A troca de máscara vale no clique, e o jogo recebe um controle novo no lugar do antigo; é por isso que o jogo fica fechado enquanto o P3 cai e volta — um jogo aberto pode tratar a volta como jogador novo, e aí o teste passa a medir o jogo. (4) Com o «Status» em «Desligado», ou o Modo em «Navegação», não há controle montado pelo Hefesto, e nada do que você escolher chega ao jogo até ele voltar a entregar. E o degrau: esta linha do mapa não tem degrau escrito, de propósito — tomar o controle e montar um controle novo é ato do computador, e o mapa registra que pelo rádio isso funciona sem nenhuma trava de transporte: é essa igualdade que os passos medem.
...
**Onde olhar.** Na fita do topo, o chip de cada controle: o número, o nome da cor do plástico e a borda pintada com essa cor. Na aba Controles, dentro do quadro «Dispositivos conectados», o cartão de cada controle: no alto, a frase «Giroscópio: fluindo para o jogo», o selo do «Microfone» (ATIVO ou DESLIGADO) e a «Bateria» com número; dentro, o bloco «Giroscópio» com X, Y e Z. No alto do quadro, o botão «Calibrar sensores de movimento», que abre a página da calibração no lugar da aba; embaixo dos cartões dela fica o bloco «Mira Virtual», com os ajustes da mira de cada controle, que este teste não toca. E na aba Iluminação, a linha «Controle», com o desenho de cada controle pintado na cor do plástico. A recusa em si — o «não» que o controle devolve a dez perguntas quando está no fio — não aparece em tela nenhuma, porque o produto nunca faz essas dez perguntas.
...
8. Dê um toque no botão PS desse mesmo aparelho — do puxão do cabo até o toque, menos de trinta segundos.
...
**A armadilha.** Três, e as três são de leitura. (1) Encaixar o cabo num controle que está no rádio não o tira do rádio no mesmo instante, e por um momento a tela pode mostrar as duas coisas; espere a linha assentar antes de anotar. (2) Na troca de braço o P3 some por um instante; o lugar dele fica guardado por trinta segundos, e o P4 continua Player 4 nesse meio — só se a troca passar disso ele desce a Player 3 até o P3 voltar; siga-os pelo plástico. (3) Os números em Hz que aparecem ao lado de cada controle em «Rádio e Adaptadores» são leitura viva do que chega agora, e mudam sozinhos; o que este teste lê ali é a PRESENÇA e a AUSÊNCIA do controle, não o valor. E o degrau: esta linha do mapa não tem degrau escrito. O que está medido é o que cada braço declara, lido em 15 de agosto com os quatro aparelhos passando pelos dois lados: o que só o rádio anuncia continuou sendo só do rádio, com os aparelhos trocados de braço. A lista segue o braço, não a unidade.
...
6. Confira na fita que o chip com o plástico do P3 saiu e que os outros três seguem com o número do começo — o lugar do P3 fica guardado por trinta segundos.
...
* **P4** — BT, e é o vizinho de rádio de quem caiu. Enquanto o P3 está fora, ele segue como P4 — o lugar do P3 fica guardado —, até o «Reconectar controles» do passo 9, que fecha a fila na hora: dali até o P3 voltar, ele aparece como P3. E tem de continuar na lista do adaptador dele o tempo todo. Depois é a vez dele de sair.

**A armadilha.** Este teste NÃO provoca a morte de que a linha fala, e é preciso dizer. A morte por rádio é outra coisa: o controle está pareado, o computador o dá por conectado, e mesmo assim ele não existe para o Hefesto — nasce órfão. Isso não se provoca com o botão PS, e nenhuma aba avisa sozinha quando acontece. A CURA tem hoje dois degraus. O primeiro é do próprio Hefesto: quando o computador avisa que o controle subiu pela metade, ele religa o órfão sozinho, em segundos, sem você tocar em nada. O segundo é seu: «Reconectar controles» derruba o elo morto que tenha sobrado e pede que você aperte PS. Então, se um dia um controle estiver aceso e pareado e não aparecer no Hefesto, ISSO é a morte por rádio: anote a hora, espere um minuto sem tocar em nada — é nesse tempo que o religar sozinho acontece —, e só então clique em «Reconectar controles»; se ele voltou sozinho nesse minuto, anote quantos segundos levou. Segunda, e é o que o passo 10 caça: com o P3 desligado de propósito, a frase do «Reconectar controles» pode dizer que derrubou um elo morto — e não havia elo morto nenhum, o controle só estava desligado. Anote a frase inteira: ela conta todo DualSense pareado neste computador que esteja desligado, não só o P3. Terceira: soltar o botão PS cedo demais não desliga o controle, e um aperto solto no PS abre a Steam; se ela abrir, feche-a e refaça o passo. Quarta: não conte o exame da aba Sistema como diagnóstico de rádio; ele é da máquina. Quinta: o «Reconectar controles» fecha a fila na hora — o lugar guardado do P3 deixa de esperar no clique, e é por isso que o P4 aparece como P3 do passo 9 até o P3 voltar.
...
6. Abra a aba Gatilhos, anote o «Modo» que está escolhido no L2 e no R2 da coluna do P1, escolha «Desligado» nos dois, e aperte o L2 e o R2 do P1 para sentir que ficaram leves.
...
**A armadilha.** Meio controle é o defeito que este teste caça, e ele engana porque o chip APARECE. Quando um controle sobe pela metade, o Hefesto o lista e o cartão fica sem bateria, sem movimento e sem touchpad — e isso se lê como «a tela está lenta». Por isso os passos mandam MEXER no aparelho: touchpad, giroscópio e analógico, um a um. Segunda: o lugar do P1 fica guardado por trinta segundos, e os dez segundos do passo 4 cabem nele: ninguém troca de número enquanto ele está fora. Se a volta passar do prazo, a fila se fecha de propósito — o plástico do P2 aparece como P1, e assim por diante — até o P1 voltar, e cada um recupera o seu. Isso é o produto, não defeito; é por isso que os passos seguem o P1 pelo plástico. Terceira: se o controle não voltar de jeito nenhum, troque de entrada USB antes de reprovar — entrada fraca derruba controle do cabo.
...
* **P4** — BT, o segundo, e um de cada vez. Enquanto o P3 está fora ele continua P4: o lugar do P3 fica guardado por trinta segundos, e os dez segundos do passo 4 cabem nele. Se ele cair sozinho quando você desliga o P3, o achado não é da entrada do controle: confira em «Rádio e Adaptadores», na aba Conexões, se os dois dividem o mesmo adaptador, e anote.

**A armadilha.** É NO RÁDIO que o meio controle acontece de verdade, e a razão é do aparelho: pelo rádio o DualSense nasce MUDO — manda só o essencial até alguém lhe pedir uma informação de fábrica, e é esse pedido que o vira para o relatório completo, com movimento, touchpad e bateria dentro. Se o pedido falhar, o controle acende, pareia, entra na lista e fica sem nada disso. Então «ele conectou» não é resposta neste teste: as três conferências dos passos 10 a 12 é que são. E o pedido tem prazo curto: quando expira, o sistema tenta de novo uma vez, e se a segunda também expirar a subida inteira é abandonada. Aí o Hefesto religa o controle sozinho, em segundos, quando o computador avisa a falha — espere um minuto antes de desligar e ligar de novo. Segunda: o lugar de quem sai fica guardado por trinta segundos, e dentro desse prazo ninguém troca de número; se a volta passar disso, os que vêm depois dele descem um número até ele voltar; siga-os pelo plástico. Terceira: um aperto solto no PS abre a Steam; se ela abrir, feche-a antes de seguir.
...
**A armadilha.** O Hefesto refaz a procura a cada cinco segundos, e ela ESPAÇA quando falha muitas vezes seguidas: depois de várias tentativas a espera entre uma e outra cresce, então um controle que demora quinze ou vinte segundos a voltar no fim de uma sequência longa não é defeito — é a espera crescida. Espere mais antes de reprovar, e anote quanto tempo levou. Duas coisas mais. Existem DUAS tentativas diferentes em jogo, e elas não se somam: a do Hefesto refaz a procura inteira a cada cinco segundos, e a do sistema tenta de novo um pedido de informação de fábrica dentro de uma única subida — confundir as duas faz procurar o número errado quando um controle não entra. E a cada saída do P1 o lugar dele fica guardado por trinta segundos: os outros três não trocam de número em nenhuma das cinco idas e voltas, e se um deles trocar, anote a hora. Não faça as idas e voltas depressa demais: encaixar e desencaixar sem esperar maltrata o conector, e o que você mede passa a ser o seu gesto, não o produto. Não clique em «Restaurar de fábrica», que fica na mesma faixa «Avançado».
...
**Passa quando.** Nas cinco voltas, o controle do rádio termina de volta na fita, com o mesmo número, e o cartão dele responde em todos os campos vivos. Se em alguma volta ele acendeu sem aparecer na lista, ele entrou sozinho dentro do minuto — ou, passado o minuto, o «Reconectar controles» ou um desligar e ligar resolveu —, e isso ainda vale como passa, desde que você anote em quantas das cinco aconteceu, quantos segundos levou e o que resolveu.
...
* **P4** — BT, o segundo, e é o que mais costuma sofrer — ele é o último da fila e pode dividir o adaptador com o P3. Enquanto o P3 está fora, ele continua P4 — o lugar do P3 fica guardado por trinta segundos —; se uma volta passar disso, ou se o «Reconectar controles» for clicado, a fila se fecha e ele aparece como P3 até o P3 voltar. Se ele precisar de mais voltas que o P3, anote o número de cada um: é a diferença entre os dois que interessa.

**A armadilha.** Aqui existe uma falha que a procura de cinco em cinco segundos não conserta, e reconhecê-la é o ponto do teste. Pelo rádio, o pedido de informação de fábrica que o controle precisa responder para subir inteiro tem prazo de três segundos, e com o Hefesto instalado o sistema tenta DUAS vezes. Se as duas expiram, a subida morre inteira: o controle fica aceso, pareado, e simplesmente não existe para o Hefesto — procurar de novo não salva esse caso, porque não há o que procurar. Hoje quem salva é o próprio Hefesto: quando o computador avisa a falha, ele religa o controle sozinho, em três passadas, e a última vem uns vinte segundos depois do aviso. Por isso o passo 9 espera um minuto sem tocar em nada: um «Reconectar controles» no meio derruba o elo enquanto as passadas ainda estão religando, e atrapalha a segunda e a terceira. Só se o minuto passar sem ele entrar é que o «Reconectar controles», ou desligar e ligar o controle de novo, é o gesto. Duas outras: conte os segundos a partir de quando você SOLTA o botão, não de quando aperta; e não religue depressa demais — deixe pelo menos cinco segundos desligado entre uma volta e a seguinte. E um aperto solto no PS abre a Steam; se ela abrir, feche-a. Não clique em «Restaurar de fábrica», que fica na mesma faixa «Avançado».
...
* **P3** — BT, testemunha. Não encoste nele. A palavra do chip dele tem de continuar BT enquanto os cabos vão e vêm. Se ela virar USB sem ninguém encostar, a leitura pegou o controle errado. O número dele não muda enquanto o cabo do P1 troca de entrada: o lugar do P1 fica guardado por trinta segundos.
...
**A armadilha.** A que o mapa declara: o Hefesto decide isto pelo TAMANHO do que o controle manda e pela entrada que o sistema mostra, e nenhum dos dois separa cabo de DADO de cabo de SÓ CARGA. Se você usar um cabo de carregador que não passa dado, o controle continua dizendo BT com o cabo espetado — e isso está CERTO, porque a entrada dele continua chegando pelo rádio; o que a tela não conta é que ele está carregando. Não reprove: troque por um cabo de dado e refaça. Segunda: enquanto um cabo está fora, o lugar daquele controle fica guardado por trinta segundos e ninguém troca de número; se a troca de entrada passar disso, os que vêm depois dele descem um número até ele voltar — siga-os pelo plástico, e julgue a PALAVRA do fim do chip, não o número. Terceira: puxe o cabo do lado do PC; mexer no encaixe do controle o derruba à toa.
...
* **P4** — BT, e é a testemunha que mais importa: ele está no mesmo tipo de conexão do P3. Se ele também virar USB quando você espeta o cabo no P3, a leitura pegou o rádio inteiro em vez do controle escolhido, e é esse o achado. Se o P3 sumir da fita por um instante na troca, o P4 continua P4 — o lugar do P3 fica guardado por trinta segundos —; se ele demorar mais que isso, o P4 aparece como P3 até ele voltar — isso é o número, não a palavra.
...
* **P3** — BT, testemunha. Não encoste nele durante os vaivéns. O chip dele não pode sumir da fita, e ele tem de continuar respondendo no cartão. O número dele não muda enquanto o P1 vai e volta: o lugar do P1 fica guardado por trinta segundos.
...
* **P4** — BT, o segundo. Três voltas de desligar e religar, sem sair do lugar. Ele separa o que é do rádio inteiro do que é só do controle que você afastou. Enquanto o P3 está fora, ele continua P4 — o lugar do P3 fica guardado por trinta segundos —; se o passeio até o outro cômodo passar disso, o P4 aparece como P3 até ele voltar — isso é o número, não queda.

**A armadilha.** É AQUI que o defeito mora, e o mapa diz por quê: pelo rádio existe, dentro do controle, um contador de vida que fica congelado, e uma checagem construída sobre ele passa sempre no cabo e não enxerga nada no rádio. Então um P3 que fique na fita e não responda é o achado inteiro desta leva — anote a hora exata. Segunda: sair da fita ao ir para o outro cômodo é o CERTO, e não defeito; o que se caça é o contrário, o chip que fica e o controle que emudece. Terceira: a troca acontece em passadas de dois em dois segundos; conte até cinco antes de decidir, ou você dá vermelho no seu próprio relógio. Quarta: o controle que ACENDE e não entra na fita é outro defeito, e o Hefesto cuida dele sozinho. Se o controle subiu pela metade — pareado, com o Bluetooth do computador sabendo quem ele é —, o Hefesto o religa em segundos, quando o computador avisa a falha; o vigia de elo morto não mexe nele. Se o que sobrou foi só o elo de rádio, sem ninguém que o computador reconheça do outro lado, esse vigia o derruba depois de uns vinte segundos. Se acontecer, espere um minuto e anote quanto tempo levou; se ele não entrar, desligue e ligue o controle de novo — e não conte como reprovação desta linha. Quinta: nada disto foi medido no aparelho até hoje — o mapa registra a leitura como achado de fonte, e o seu resultado aqui é a primeira medição que esta casa vai ter.
...
6. Anote de qual jogador é o controle virtual dele, o que vem entre parênteses, inteiro, e, se a dica trouxer, o nome com que ele aparece no sistema.
...
11. Pare o ponteiro sobre o nome do P3 de novo e confira que a dica voltou a nomear um controle virtual, do mesmo jogador de antes e com o mesmo endereço entre parênteses.
12. Pare o ponteiro sobre o nome do P4 e confira que a dica dele nomeia o jogador de antes.
...
14. Com o P1 no Forte, abra um jogo que tenha perfil próprio no Hefesto, volte à aba Iluminação com o jogo aberto e confira que a pílula acesa do P1 continua Forte e as lâmpadas dele também; feche o jogo.
15. Faça na coluna do P2 a mesma volta: Forte, Fraco e Médio, a barra olhada à parte, o cabo que sai e volta, e o jogo que abre.
16. Devolva as colunas do P1 e do P2 às pílulas anotadas.
17. Anote as respostas lado a lado: os três degraus do P1, a barra do P1, a volta pelo cabo do P1, a pílula com o jogo aberto, e o mesmo do P2.

**Passa quando.** Os três cliques mudam as lâmpadas de numeração em três degraus que se distinguem a olho — Forte o mais claro, Fraco o mais apagado —, nos dois controles do cabo, e a barra de luz colorida não muda com nenhum deles. O clique numa coluna muda só aquele controle. O controle que volta pelo cabo volta no degrau que tinha. E com o jogo aberto a pílula acesa é a das lâmpadas: até 25/09 ela mostrava o degrau do perfil do jogo enquanto as lâmpadas seguiam no Forte. Se as lâmpadas NÃO mudarem, anote em qual degrau e em qual controle: o report sai com o bit, e o que falhou é o caminho até o plástico.
...
15. Com o P3 no Forte, abra um jogo que tenha perfil próprio no Hefesto, volte à aba Iluminação com o jogo aberto e confira que a pílula acesa do P3 continua Forte e as lâmpadas dele também; feche o jogo.
16. Faça na coluna do P4 a mesma volta: Forte, Fraco e Médio, a barra olhada à parte, as testemunhas do cabo, o desligar e religar pelo PS, e o jogo que abre.
17. Devolva as colunas do P3 e do P4 às pílulas anotadas.
18. Anote as respostas lado a lado: os três degraus do P3, a barra do P3, a volta pelo rádio do P3, a pílula com o jogo aberto, o mesmo do P4, e as testemunhas do cabo.

**Passa quando.** Os três cliques mudam as lâmpadas de numeração em três degraus que se distinguem a olho — Forte o mais claro, Fraco o mais apagado —, nos dois controles do rádio, e a barra de luz colorida não muda com nenhum deles. As lâmpadas do P1 e do P2 ficam paradas o tempo todo: o clique numa coluna não pode mexer no outro controle. O controle que volta pelo rádio acende no degrau que tinha. E com o jogo aberto a pílula acesa é a das lâmpadas: até 25/09 ela mostrava o degrau do perfil do jogo enquanto as lâmpadas seguiam no Forte. Se as lâmpadas do P3 ou do P4 NÃO mudarem, anote em qual degrau e em qual controle.
...
**Onde olhar.** Na aba Controles, no cartão de um controle ligado pelo cabo — na fita do topo, o chip dele diz USB. Dentro do cartão, o bloco Microfone: as barrinhas que se mexem com a voz, e o trilho Volume com o número ao lado. Fora do Hefesto, o painel de som do sistema, na lista de ENTRADAS: cada controle tem a sua, «Microfone do Controle 1 (DualSense Wireless Controller)» para o P1, «Microfone do Controle 2 (DualSense Wireless Controller)» para o P2.
...
5. Abra o painel de som do sistema e ache, nas entradas, o «Microfone do Controle 1 (DualSense Wireless Controller)».
...
11. Confira no painel de som que o «Microfone do Controle 1 (DualSense Wireless Controller)» acompanhou.
12. Faça no P2 a mesma volta, com o «Microfone do Controle 2 (DualSense Wireless Controller)».
...
**Onde olhar.** Na aba Controles, no cartão de um controle ligado pelo rádio — na fita do topo, o chip dele diz BT. Dentro do cartão, o bloco Microfone: o selo ATIVO ou DESLIGADO ao lado do nome, as barrinhas que se mexem com a voz, o trilho Volume com o número e o 🎙 ao lado. O 🎙 é o retorno: aceso em verde, você se ouve pela saída de som do computador, com o volume do cartão já aplicado, e ele assim FICA até o clique seguinte. Fora do Hefesto, o painel de som do sistema, nas ENTRADAS: «Microfone do Controle 3 (DualSense Wireless Controller)» para o P3, «Microfone do Controle 4 (DualSense Wireless Controller)» para o P4.
...
6. No painel de som do sistema, mude o volume da entrada «Microfone do Controle 3 (DualSense Wireless Controller)» para 30.
7. Volte ao Hefesto sem clicar em nada e espere dois segundos.
...
16. Faça no P4 a mesma volta, com o «Microfone do Controle 4 (DualSense Wireless Controller)».
