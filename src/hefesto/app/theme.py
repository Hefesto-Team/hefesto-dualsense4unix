"""Aplicação do tema Drácula ao Hefesto via Gtk.CssProvider.
...
from hefesto.app.constants import GUI_DIR
...
def apply_theme(window: Gtk.Window) -> None:
    """Carrega theme.css e aplica à janela principal com classe .hefesto-window.
