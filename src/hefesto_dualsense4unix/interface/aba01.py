...
CSS = """
  ...
  /* ---------- AS DUAS LINHAS POR CIMA DOS LUGARES — 04/09/2026 ----------
     ...
     aprovou. O fundo é o do quadro, para a borda dos cartões não cortar a
     frase. E ela não pega clique, porque com mais controles que lugares a
     mesma linha pousa sobre cartões cheios, que continuam clicáveis por baixo.
     As duas linhas dividem o lugar: a ressalva da máscara sai vazia em todo
     modo desde a JOGAR-A-FAIXA-QUE-PULA-01, então só a da mesa acende. */
  .quadro-corpo > div:has(> .pecas){position:relative}
  .mesa-notas:not(.ha){display:none}
  .mesa-notas{position:absolute;left:0;right:0;top:50%;transform:translateY(-50%);
              z-index:1;margin:0;text-align:center;pointer-events:none}
      ...
      <div class="quadro-corpo">
        ...
        <div>
            <!-- ---------- AS DUAS LINHAS POR CIMA DOS LUGARES ----------
                 ...
                 a linha pousa POR CIMA da fileira, fora do fluxo — desde
                 13/09/2026 (RECONECTAR-SAMBA-02), porque acima dela empurrava
                 o «Reconectar controles» 27 px para baixo.
