...
#: (`daemon/lifecycle.py:2917`, a cura da queixa dela de 29/07 *"aperto r1 e ele
...
LEGENDA = f'''<div class="nota">
  ...
  <ul>
    ...
    <li><b>Com três ou quatro controles na mesa, o P3 e o P4 deixaram de aparecer
    apagados</b>, com a cara de lugar vazio. Eles nascem vazios no desenho, e a
    tela só tirava essa cara do P2. Agora quem está na mesa aparece como o P2, e
    quem saiu fica apagado, nos quatro lugares.</li>
  </ul>
