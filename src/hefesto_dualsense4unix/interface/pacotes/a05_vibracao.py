...
def _indice(ctx: Contexto, uniq: str) -> int:
    ...
    `daemon/ipc_handlers.py:5108`. O número sai do próprio bloco `controllers`
    (`core/backend_pydualsense.py:7304`, `"index": idx`), que é a posição em
    ...
    `_numero_de_exibicao` (`ipc_handlers.py:618`). E se o controle não estiver
