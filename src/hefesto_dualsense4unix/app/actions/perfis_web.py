...
DONOS_DOS_GESTOS: dict[str, str] = {
    ...
    "(daemon/state_store.py:693). O TÍTULO é que não é publicado. Quem quiser o "
...
def _id_visivel(uniq: str) -> str:
    ...
    (``profiles/schema.py:1113``, canonizada em ``:1141``). Endereço que não é a
...
def _pacote_do_editor(profile: Any) -> dict[str, Any]:
    ...
    # 100 — e o teto do produto é 200 (`profiles/schema.py:1658`, com portão
