...
_PONTOS_DE_ENTRADA: dict[str, tuple[str, str, str]] = {
    ...
    "integrations/audio_ks_dualsense.py": (
        ...
        "install.sh:2997 o copia para ~/.local/share/hefesto-dualsense4unix/"
        "bin/hefesto-audio-ks, e o assets/hefesto-launch.sh:445 "
        "(curar_audio_ks) o roda a cada jogo lançado; uninstall.sh:1609 o "
...
_SEM_CAMINHO_HOJE: dict[str, str] = {
    "integrations/cura_por_estrada.py::Estrada":
        ...
        "não a cura: o módulo e as 26 provas ficam. a resposta de UMA "
        "estrada — o arquivo, o formato e a permissão que volta como "
        "estava. ONDE O CAMINHO SE PERDE, e é UM ponto: "
    ...
    "integrations/cura_por_estrada.py::Plano":
        "O BOTÃO «Consertar» DOS CARTÕES SEM CENSO SAIU EM 10/09/2026 "
        "(LANCADOR-LOCALIZAR-01), por palavra dela — 'se tenho tudo "
        "instalado e tá pra ser identificado não tem pq ter o botão de "
        "consertar' —, e com ele o gesto "
        "`a07_lancadores.consertar_lancador` e a consulta de "
        "`desenho_dos_lancadores.medir_no_disco`. O que caiu foi o VASO, "
        "não a cura: o módulo e as 26 provas ficam. o que a cura VAI "
        "escrever, respondido antes de tocar em disco. ONDE O CAMINHO SE "
        "PERDE, e é UM ponto: `assets/hefesto-launch.sh` só age com "
        "`SteamAppId`, e nenhum jogo do Heroic, do Lutris, do RetroArch, do "
        "Dolphin ou do mGBA tem um — este módulo é o ÚNICO código desta "
        "casa que entrega o ambiente da ponte a um lançador que não é a "
        "Steam, e a lacuna continua aberta. O que FECHA: a "
        "LANCADOR-CARONA-01, que põe a cura na CARONA em vez de num botão — "
        "palavra dela de 16/08/2026 (`app/actions/carona_do_wrapper.py:7`), "
        "o mesmo lugar em que `interface/pacotes/perfil.com_a_carona()` já "
        "repõe o atalho da Steam ao Salvar e ao Aplicar. `perfil.py` e o "
        "rodapé são de outra posse, e a cura escreve em arquivo de OUTRO "
        "programa — o que merece a palavra dela sobre 'sem botão, no "
        "Salvar' antes de qualquer linha. No dia em que ela nascer, este "
        "portão cobra que estas entradas sejam APAGADAS. 10/09/2026.",
    "integrations/cura_por_estrada.py::ambiente_da_ponte":
        "O BOTÃO «Consertar» DOS CARTÕES SEM CENSO SAIU EM 10/09/2026 "
        "(LANCADOR-LOCALIZAR-01), por palavra dela — 'se tenho tudo "
        "instalado e tá pra ser identificado não tem pq ter o botão de "
        "consertar' —, e com ele o gesto "
        "`a07_lancadores.consertar_lancador` e a consulta de "
        "`desenho_dos_lancadores.medir_no_disco`. O que caiu foi o VASO, "
        "não a cura: o módulo e as 26 provas ficam. lê as cinco variáveis "
        "do `default.env` do daemon em vez de deduzi-las — uma segunda "
        "conta ao lado da do daemon envelheceria calada. ONDE O CAMINHO SE "
        "PERDE, e é UM ponto: `assets/hefesto-launch.sh` só age com "
        "`SteamAppId`, e nenhum jogo do Heroic, do Lutris, do RetroArch, do "
        "Dolphin ou do mGBA tem um — este módulo é o ÚNICO código desta "
        "casa que entrega o ambiente da ponte a um lançador que não é a "
        ...
        "Salvar' antes de qualquer linha. No dia em que ela nascer, este "
        "portão cobra que estas entradas sejam APAGADAS. 10/09/2026.",
    "integrations/cura_por_estrada.py::escrever_a_estrada":
        "O BOTÃO «Consertar» DOS CARTÕES SEM CENSO SAIU EM 10/09/2026 "
        "(LANCADOR-LOCALIZAR-01), por palavra dela — 'se tenho tudo "
        "instalado e tá pra ser identificado não tem pq ter o botão de "
        "consertar' —, e com ele o gesto "
        "`a07_lancadores.consertar_lancador` e a consulta de "
        "`desenho_dos_lancadores.medir_no_disco`. O que caiu foi o VASO, "
        "não a cura: o módulo e as 26 provas ficam. a escrita atômica, com "
        "a conferência do que ficou no arquivo. ONDE O CAMINHO SE PERDE, e "
        "é UM ponto: `assets/hefesto-launch.sh` só age com `SteamAppId`, e "
        "nenhum jogo do Heroic, do Lutris, do RetroArch, do Dolphin ou do "
        "mGBA tem um — este módulo é o ÚNICO código desta casa que entrega "
        "o ambiente da ponte a um lançador que não é a Steam, e a lacuna "
        "continua aberta. O que FECHA: a LANCADOR-CARONA-01, que põe a cura "
        "na CARONA em vez de num botão — palavra dela de 16/08/2026 "
        "(`app/actions/carona_do_wrapper.py:7`), o mesmo lugar em que "
        "`interface/pacotes/perfil.com_a_carona()` já repõe o atalho da "
        "Steam ao Salvar e ao Aplicar. `perfil.py` e o rodapé são de outra "
        "posse, e a cura escreve em arquivo de OUTRO programa — o que "
        ...
        "qualquer linha. No dia em que ela nascer, este portão cobra que "
        "estas entradas sejam APAGADAS. 10/09/2026.",
    "integrations/cura_por_estrada.py::estradas_do_cartao":
        "O BOTÃO «Consertar» DOS CARTÕES SEM CENSO SAIU EM 10/09/2026 "
        "(LANCADOR-LOCALIZAR-01), por palavra dela — 'se tenho tudo "
        "instalado e tá pra ser identificado não tem pq ter o botão de "
        "consertar' —, e com ele o gesto "
        "`a07_lancadores.consertar_lancador` e a consulta de "
        "`desenho_dos_lancadores.medir_no_disco`. O que caiu foi o VASO, "
        "não a cura: o módulo e as 26 provas ficam. quais estradas aquele "
        "cartão tem. ONDE O CAMINHO SE PERDE, e é UM ponto: "
        "`assets/hefesto-launch.sh` só age com `SteamAppId`, e nenhum jogo "
        "do Heroic, do Lutris, do RetroArch, do Dolphin ou do mGBA tem um — "
        "este módulo é o ÚNICO código desta casa que entrega o ambiente da "
        "ponte a um lançador que não é a Steam, e a lacuna continua aberta. "
        ...
        "qualquer linha. No dia em que ela nascer, este portão cobra que "
        "estas entradas sejam APAGADAS. 10/09/2026.",
    "integrations/cura_por_estrada.py::frase_do_feito":
        "O BOTÃO «Consertar» DOS CARTÕES SEM CENSO SAIU EM 10/09/2026 "
        "(LANCADOR-LOCALIZAR-01), por palavra dela — 'se tenho tudo "
        "instalado e tá pra ser identificado não tem pq ter o botão de "
        "consertar' —, e com ele o gesto "
        "`a07_lancadores.consertar_lancador` e a consulta de "
        "`desenho_dos_lancadores.medir_no_disco`. O que caiu foi o VASO, "
        "não a cura: o módulo e as 26 provas ficam. o recibo que a tela "
        "mostra depois de escrever. ONDE O CAMINHO SE PERDE, e é UM ponto: "
        "`assets/hefesto-launch.sh` só age com `SteamAppId`, e nenhum jogo "
        "do Heroic, do Lutris, do RetroArch, do Dolphin ou do mGBA tem um — "
        "este módulo é o ÚNICO código desta casa que entrega o ambiente da "
        "ponte a um lançador que não é a Steam, e a lacuna continua aberta. "
        ...
        "qualquer linha. No dia em que ela nascer, este portão cobra que "
        "estas entradas sejam APAGADAS. 10/09/2026.",
    "integrations/cura_por_estrada.py::planejar":
        "O BOTÃO «Consertar» DOS CARTÕES SEM CENSO SAIU EM 10/09/2026 "
        "(LANCADOR-LOCALIZAR-01), por palavra dela — 'se tenho tudo "
        "instalado e tá pra ser identificado não tem pq ter o botão de "
        "consertar' —, e com ele o gesto "
        "`a07_lancadores.consertar_lancador` e a consulta de "
        "`desenho_dos_lancadores.medir_no_disco`. O que caiu foi o VASO, "
        "não a cura: o módulo e as 26 provas ficam. monta o `Plano` a "
        "partir das estradas e do ambiente. ONDE O CAMINHO SE PERDE, e é UM "
        "ponto: `assets/hefesto-launch.sh` só age com `SteamAppId`, e "
        "nenhum jogo do Heroic, do Lutris, do RetroArch, do Dolphin ou do "
        "mGBA tem um — este módulo é o ÚNICO código desta casa que entrega "
        "o ambiente da ponte a um lançador que não é a Steam, e a lacuna "
        "continua aberta. O que FECHA: a LANCADOR-CARONA-01, que põe a cura "
