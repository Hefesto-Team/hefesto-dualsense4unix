...
_SEM_CAMINHO_HOJE: dict[str, str] = {
    ...
    "daemon/subsystems/ipc.py::stop_ipc": (
        ...
        "`daemon/connection.py:1403` e derruba o IPC ele mesmo, em linha: "
    ...
    "daemon/subsystems/udp.py::stop_udp": (
        ...
        "`shutdown` (`daemon/connection.py:1403`) derruba — "
    ...
    "daemon/subsystems/autoswitch.py::stop_autoswitch": (
        ...
        "(`daemon/connection.py:1403`) chama `daemon._autoswitch.stop()` "
