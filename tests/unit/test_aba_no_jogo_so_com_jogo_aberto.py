...
class _DaemonDeLaco(_DaemonDeSonda):
    ...
    # O `_poll_loop` ganhou esta chamada em `cacd786cb` (O-NO-NASCE-FECHADO-01,
    # 20/09/2026) e o dublê não ganhou o irmão: dois testes desta bancada caíram
    # com `AttributeError`, três arquivos longe da causa. Ver
    # `test_o_duble_do_poll_loop_acompanha_o_produto.py`, a régua que impede a
    # próxima vez lendo o laço de produção por AST.
